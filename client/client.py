...
from .autoencoder_model_trainer import AutoencoderModelTrainer
...
class Client:
    ...
    def do_training(self, training_type, model_params, federated_learning_config):
        if self.can_do_training():
            ...
            elif self.training_type == TrainingType.AUTO_ENCODER:
                client_model_trainer = AutoencoderModelTrainer(model_params, federated_learning_config)
            else:
